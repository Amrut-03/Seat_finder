...
List<Widget> allSelectedSeats = [
  ...
  getSelectedLowerSeat(seatnum: '25', seat_type: 'LOWER'),
  getSelectedLowerSeat(seatnum: '26', seat_type: 'MIDDLE'),
  getSelectedLowerSeat(seatnum: '27', seat_type: 'UPPER'),
  getSelectedUpperSeat(seatnum: '28', seat_type: 'LOWER'),
  getSelectedUpperSeat(seatnum: '29', seat_type: 'MIDDLE'),
  getSelectedUpperSeat(seatnum: '30', seat_type: 'UPPER'),
  getSelectedLowerSeat(seatnum: '31', seat_type: 'SIDE LOWER'),
  getSelectedUpperSeat(seatnum: '32', seat_type: 'SIDE UPPER'),
  getSelectedLowerSeat(seatnum: '33', seat_type: 'LOWER'),
  getSelectedLowerSeat(seatnum: '34', seat_type: 'MIDDLE'),
  getSelectedLowerSeat(seatnum: '35', seat_type: 'UPPER'),
  getSelectedUpperSeat(seatnum: '36', seat_type: 'SIDE UPPER'),
  getSelectedUpperSeat(seatnum: '37', seat_type: 'LOWER'),
  getSelectedUpperSeat(seatnum: '38', seat_type: 'MIDDLE'),
  getSelectedLowerSeat(seatnum: '39', seat_type: 'SIDE LOWER'),
  getSelectedUpperSeat(seatnum: '40', seat_type: 'SIDE UPPER'),
];
